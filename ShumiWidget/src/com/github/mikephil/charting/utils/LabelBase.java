...
public abstract class LabelBase {
    ...
    private LabelColorFormatter mLabelColorFormatter;
	...
	public LabelColorFormatter getLabelColorFormatter() {
		return mLabelColorFormatter;
	}

	public void setLabelColorFormatter(LabelColorFormatter formatter) {
		this.mLabelColorFormatter = formatter;
	}
