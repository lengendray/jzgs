...
public abstract class Chart<T extends ChartData<? extends DataSet<? extends Entry>>> extends View
     ...
     */
	protected void clearDrawBitmap() {
		if (mDrawCanvas != null) {
    ...
    protected void prepareContentRect() {
		...
		mContentRect.set((int) mOffsetLeft - offset, (int) mOffsetTop - offset,
				getMeasuredWidth() - (int) mOffsetRight + offset,
				getMeasuredHeight() - (int) mOffsetBottom);
    }
    ...
    protected void drawLegend() {
        ...
        switch (mLegend.getPosition()) {
            ...
            case ABOVE_CHART_CENTER:
            	  ...
            	  float fullWidth = mLegend.getFullWidth(mLegendLabelPaint);

                  posX = getWidth() / 2f - fullWidth / 2f;
                  posY = mLegend.getOffsetTop() / 2f + formSize / 2f;
    ...
    protected void drawMarkers() {
        ...
        for (int i = 0; i < mIndicesToHightlight.length; i++) {
            ...
            if (xIndex <= mDeltaX && xIndex <= mDeltaX * mPhaseX) {
                ...
                int w = mMarkerView.getMeasuredWidth();
                int h = mMarkerView.getMeasuredHeight();
                mMarkerView.layout(0, 0, w, h);
				mMarkerView.draw(mCanvas, pos[0] - w / 2, pos[1] - h);
            }
        }
    }
    ...
    public static final int PAINT_LEGEND_FORM = 18;
    
    /** paint used for the legend */
    public static final int PAINT_LEGEND_LABEL = 19;
    
    /** paint object used for the limit lines */
    public static final int PAINT_LIMIT_LINE = 20;
